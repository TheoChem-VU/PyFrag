...
latex_documents = [
    (master_doc, 'qmflows.tex', 'qmflows Documentation',
     'F. Zapata, L. Ridder, B. F. van Beek', 'manual'),
]
...
man_pages = [
    (master_doc, 'qmflows', 'qmflows Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'qmflows', 'qmflows Documentation',
     author, 'qmflows', 'One line description of project.',
     'Miscellaneous'),
]
