...
# 2. Create a virtual environment (Python) with the pyfrag package installed through `uv sync`
# Do use cache (as this may give unexpected errors when solving dependencies)
...
echo "Finally, please make sure to set the PYFRAGSOURCE environment variable in the module file to /src/pyfrag folder"