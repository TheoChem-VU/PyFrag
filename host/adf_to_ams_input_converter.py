    ...
    def _get_molecule(self):
        ...
        if "units" in self.adf:
            self.warnings.append(
                'The key "Units" was defined in the input. The atomic coordinates have been converted to the proper unit, but other geometrical data (if present) has not been converted.'
            )
