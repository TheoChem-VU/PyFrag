...
parser.add_argument("--optimize_fragments", action="store_true", help="optimize the fragments to calculate strain for the ASM model")


# Set default values
inputKeys = {"jobstate": None, "filename": "pyfrag_calc", log_level: logging.INFO, "strain": {"frag1": 0, "frag2": 0}, "optimize_fragments": False}
