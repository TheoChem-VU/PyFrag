...
parser.add_argument("--ircpath", type=str, action="append", nargs="*", help="DEPRECETAEDIRC. coordinate file")
parser.add_argument("--irct21", type=str, action="append", nargs="*", help="DEPRECETAEDIRC. coordinate file")
...
parser.add_argument("--frag1_indices", type=str, action="append", nargs="*", help="atom number(s) (starting from 1) for the first fragment")
parser.add_argument("--frag2_indices", type=str, action="append", nargs="*", help="atom number(s) (starting from 1) for the second fragment")

parser.add_argument("--strain", type=float, action="append", nargs="*", help="the energy of the fragment. ")
parser.add_argument("--frag1_energy", type=float, nargs=1, help="the energy of the first fragment.")
parser.add_argument("--frag2_energy", type=float, nargs=1, help="the energy of the second fragment.")
