...
submit="source \$HOSTPYFRAG/src/pyfrag/venv_runner.sh && run_pyfrag_cluster \$HOSTPYFRAG/src/pyfrag/cluster_runner.py --backend adf_open --job-dir \$PWD --input-file adfinputfile"
