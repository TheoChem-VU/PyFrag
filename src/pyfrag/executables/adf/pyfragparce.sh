...
submit="source \${HOSTPYFRAG}/src/pyfrag/venv_runner.sh && run_pyfrag_cluster \${HOSTPYFRAG}/src/pyfrag/cluster_runner.py --backend adf_new --job-dir \$(pwd) --input-file $input \\"
