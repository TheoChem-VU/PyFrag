...
from plams import *
from PyFragModules import WriteFailFiles, WriteTable, pyfrag_driver
...
tableValue, fileName, failStructures = pyfrag_driver(inputKeys, settings_Frag1, settings_Frag2, settings_Fa)
